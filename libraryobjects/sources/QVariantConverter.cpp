...
QVariant libraryObjects::QVariantConverter::deserialize(QVariant::Type type, const QJsonValue &json)
{
	switch (type) {
	case QVariant::Size:
...
QJsonValue libraryObjects::QVariantConverter::serializeSize(const QVariant &variant) const
{
...
QVariant libraryObjects::QVariantConverter::deserializeSize(const QJsonValue &value) const
{
	QSize size;
...
QJsonValue libraryObjects::QVariantConverter::serializeSizeF(const QVariant &variant) const
{
...
QVariant libraryObjects::QVariantConverter::deserializeSizeF(const QJsonValue &value) const
{
	QSizeF sizeF;
	QJsonObject json = value.toObject();
...
QJsonValue libraryObjects::QVariantConverter::serializeRect(const QVariant &variant) const
{
...
QVariant libraryObjects::QVariantConverter::deserializeRect(const QJsonValue &value) const
{
	QRect rect;
	QJsonObject json = value.toObject();
...
QJsonValue libraryObjects::QVariantConverter::serializeRectF(const QVariant &variant) const
{
...
QVariant libraryObjects::QVariantConverter::deserializeRectF(const QJsonValue &value) const
{
	QRectF rectF;
	QJsonObject json = value.toObject();
...
QJsonValue libraryObjects::QVariantConverter::serializeSizePolicy(const QVariant &variant) const
{
...
QVariant libraryObjects::QVariantConverter::deserializeSizePolicy(const QJsonValue &value) const
{
...
QJsonValue libraryObjects::QVariantConverter::serializeKeySequence(const QVariant &variant) const
{
...
QVariant libraryObjects::QVariantConverter::deserializeKeySequence(const QJsonValue &value) const
{
	QJsonObject json = value.toObject();
...
QJsonValue libraryObjects::QVariantConverter::serializeLocale(const QVariant &variant) const
{
...
QVariant libraryObjects::QVariantConverter::deserializeLocale(const QJsonValue &value) const
{
	QJsonObject json = value.toObject();
