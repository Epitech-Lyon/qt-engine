...
namespace codingJourney {
	namespace workflow {
		...
		namespace dataModel {
			class OperatorRelational : public NodeDataModel {
				Q_OBJECT

			public:
				OperatorRelational();
				~OperatorRelational() = default;

			public:
				QJsonObject save() const override;
				void restore(QJsonObject const &) override;

				QString name() const override { return "OperatorRelational"; }

				QString caption() const override { return "Operator Arythmetical"; }
